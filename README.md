...
> information like latest NAV, fund type , option . Each fund can be clicked and get detailed info for example
> timeseries Line chart for 6month , 1 year and all time , its NAV and ability to add it or create new watchlist to
...
- **Explore:** Categorized based on the type of fund like index , bluechip , tax with a view all button which
  caters all similar type of funds under a single umbrella .
...
* Have Android studio 
* A android device or AVD to test the application
...
1. Clone the repository:
   ```bash
   git clone https://github.com/TheHamckerCapy/groww_MF_assignment.git
